...
<body>
	<div align="center">
		...
		<table border="1" cellspacing="0" width="450">
			...
			<tr>
				<td colspan="4" align="center">
				<input type="submit" value="상품 등록" onclick="location.href='product_insert.do'">&nbsp;&nbsp;&nbsp;
				<input type="submit" value="전체 목록" onclick="location.href='product_list.do'">
				</td>
			</tr>
		</table>
