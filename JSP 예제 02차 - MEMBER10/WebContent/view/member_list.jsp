...
<body>
	...
	<div align="center">
		...
		<table border="1" cellspacing="0" width="350">
			<tr>
				<!-- <th>회원번호</th><th>회원아이디</th><th>회원명</th>
				<th>회원비밀번호</th><th>회원나이</th><th>회원마일리지</th>
				<th>회원직업</th><th>회원주소</th><th>가입일</th> -->
				<th>회원번호</th>
				<th>회원아이디</th>
				<th>회원명</th>
				<th>가입일</th>
			...
			<%  }	%>
			<tr>
				<td colspan="4" align="right"><input type="button" value="회원등록"
					onclick="location.href='view/member_join.jsp'"></td>
			</tr>
		</table>
	</div>
</body>
